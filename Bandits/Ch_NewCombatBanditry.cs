...
{
    public class Ch_NewCombatBanditry : Challenge
    {
        ...
        public Ch_NewCombatBanditry(Pr_New_Banditry banditry, Location loc)
            : base(loc)
        {
        ...
        {
            return "Combat Banditry";
        }

        public override string getDesc()
        {
            // The values for the description are now pulled dynamically from the variables.
            return "Reduces the banditry property by " + (int)chargeReduction + " and reduces danger by " + dangerReduction + ".";
        }
        ...
        public override double getProgressPerTurnInner(UA unit, List<ReasonMsg> msgs)
        {
            ...
            double progress = unit.getStatMight();
            if (progress < 1)
            {
            ...
            else
            {
                ...
                msgs?.Add(new ReasonMsg("Stat: Might", progress));
            }
        ...
        public override void complete(UA u)
        {
            ...
            if (banditry != null)
            {
                banditry.charge = Math.Max(0.0, banditry.charge - chargeReduction);
            }
        }
