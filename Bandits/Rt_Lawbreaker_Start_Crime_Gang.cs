...
{
    public class Rt_Lawbreaker_Start_Crime_Gang : Ritual
    {
        public Pr_Crime crime;

        public Rt_Lawbreaker_Start_Crime_Gang(Location loc)
            : base(loc)
        {
        }
        ...
        {
            return "Start Crime Gang";
        }

        public override string getCastFlavour()
        {
            return "The downtrodded and oppressed of society can be organized intro pursuits more useful to our interests.";
        }
        ...
        {
            return "Creates a Crime Modifier in this location at 100%. Requires an infiltrated City.";
        }

        public override void complete(UA u)
        {
            Pr_Crime crime = null;
            crime = new Pr_Crime(location);
            crime.charge = 100.0;
            location.properties.Add(crime);
        }

        public override string getRestriction()
        {
            return "Requires a partially infiltrated city.";
        }
        ...
        public override bool valid()
        {
            ...
            if (!(location.settlement is Set_City) && checker == true)
            {
                checker = false;
            }
            return base.location.settlement != null && base.location.settlement.infiltration != 0 && checker;
        }
