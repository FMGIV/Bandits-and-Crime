...
{
    public class Ch_FundCriminals : Ch_ArmBandits
    {
        public Pr_Crime Crime;

        public int dangerincrease = 3;
        public Ch_FundCriminals(Pr_Crime Crime, Location loc)
            : base(loc)
        {
            this.Crime = Crime;
        }
        ...
        {
            return "Fund Criminals";
        }

        public override string getDesc()
        {
            return "Adds <b>additional danger</b> of the 'Combat Crime' quest by " + (int)dangerincrease + ", at the cost of " + map.param.ch_armBanditsGoldCost + " <b>gold</b>." + " Also boosts the Crime modifer temporarily.";
        }
